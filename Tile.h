...
public:
	...
	CONSTRUCTION=4     ///< Construction zoning
	}; 
	...
	* \param y Y location */
    ...
    virtual void Draw(Gdiplus::Graphics *graphics, CPoint translation, double scale);

    virtual void DrawBorder(Gdiplus::Graphics *graphics, Gdiplus::Pen *pen, CPoint translation, double scale);
    ...
    * \return true if clicked on */
	...
	virtual void Setways(int x)
	{
		ways = x;
	}

	virtual int getways(){ return ways; }
	...
	* \param visitor The visitor we accept */
	...
	virtual void changeelectric(int, int){};
protected:
    CTile(CCity *city);
